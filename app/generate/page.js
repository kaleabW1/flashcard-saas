...
import { Dialog, TextField, Button, Paper, Typography, Container, Box, Grid, Card, CardActionArea, CardContent, DialogTitle, DialogContent, DialogContentText, DialogActions } from "@mui/material";
...
export default function Generate() {
  ...
  return (
    <Container maxWidth="md">
      ...
      <Paper sx={{ mt: 4, mb: 6, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <TextField
          value={text}
